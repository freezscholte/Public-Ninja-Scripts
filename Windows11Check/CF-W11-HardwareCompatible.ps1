...
$Proc = (Get-CimInstance -ClassName Win32_Processor).name -split ' ' | ForEach-Object { $models | Where-Object -Property model -match $* }
...
$Compatible = "Error-1001 - This device is not compatible with Windows 11"
}
else {
$Compatible = "Info-1000 - This device is compatible with Windows 11"
}
...
#Write Out value to see in Ninja Console
$Results
